    ...
    <div className="min-h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-orange-500 to-orange-600 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12">
          ...
          >
            Créez votre compte en quelques étapes simples et accédez à toutes nos fonctionnalités.
          </motion.p>
          <motion.div
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Navigation simple et efficace</p>
                </div>
              </div>
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Protection de vos données</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-medium">Support réactif</h3>
                  <p className="text-sm text-white/80">Assistance disponible 24/7</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="absolute bottom-6 left-6">
          <p className="text-white/70 text-sm">© 2023 O'test. Tous droits réservés.</p>
        </div>
      </div>

      {/* Right panel - form */}
      <div className="w-full md:w-1/2 flex flex-col bg-background dark:bg-gray-950 relative">
        <AnimatedBackground />
